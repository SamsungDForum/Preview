// Background Service
var fgAppId = 'g3rAasdgsM.BackgroundServiceMP'; // application
var bgServiceId = 'g3rAasdgsM.service'; // service

var messagePortName = 'FOREGROUND_APP_PORT';

//endpoint url
var default_host_url = 'developer.samsung.com';
var default_endpoint_url = '/onlinedocs/tv/Preview/sampleJSON.json';
...
function sendMessage () {
	...
	var jsonText = '{"type": "https", "host": "'+ default_host_url +'", "endpoint": "'+ default_endpoint_url +'"}';
	var remotePort = tizen.messageport.requestRemoteMessagePort(bgServiceId, messagePortName);
